...
client.on("guildMemberAdd", member => {
  ...
  return channel.send(`**・。・゜★ :flag_tn: ­ The DamNation:tm: - Official Server - :flag_tn:。・。☆ , OHH HI I'AM HIROKA BOT (✿◠‿◠) MADE BY : - "THE RARE RANGER" - FOR MAKE - TDN MEMBERS - HAPPY ^^ , SO BE COOL TO OTHER MEMBERS ! BECAUSE I HAVE THE PERMISSIONS TO KICK AND BAN SO BE CAREFUL... , AND YEAH WAIT : "5 - MINUTES" TO GET YOUR ROLE - HAVE FUN** :heart:`)
}).catch(console.error)
})
