...
client.on("guildMemberAdd", member => {
  ...
  return channel.send(`**☆ OHH HI I'AM "HIROKA" BOT (✿◠‿◠) MADE BY : - :flag_tn: "THE RARE RANGER" :flag_tn: - FOR MAKE - TDN MEMBERS - HAPPY ^^ , SO BE COOL TO OTHER MEMBERS ! BECAUSE I HAVE THE PERMISSIONS TO KICK AND BAN SO BE CAREFUL. , AND YEAH WAIT : "5 - MINUTES" TO GET YOUR ROLE - HAVE FUN ☆** :heart:`)
}).catch(console.error)
})
